...
def run_model(path_to_model, path_to_output):
    ...
    model = update_constraint_sets(model) # new line
...
def update_constraint_sets(model): # prevent `core` constraint from clashing with these custom constraints and the specificially related techs
